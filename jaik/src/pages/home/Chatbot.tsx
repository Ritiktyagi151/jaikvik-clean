...
const WhatsAppButton: React.FC = () => {
  ...
  const emailAddress = "info@jaikvik.com";
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col items-center gap-3 fixed bottom-20 right-6 z-[9999]">
        ...
        {/* Phone */}
        <a href={phoneLink} aria-label="Call us" className="group relative">
        ...
        {/* Email */}
        <a href={mailLink} aria-label="Email us" className="group relative">
      ...
      <div className="md:hidden fixed bottom-20 right-6 z-[9999] flex flex-col items-center gap-3">
        ...
        <button
          ...
          aria-label={
            mobileOpen ? "Close contact options" : "Open contact options"
          }
